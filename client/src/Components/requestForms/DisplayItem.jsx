...
const DisplayItem = ({ documentId = undefined, item, index, deleteItem, detailsPage = false }) => {
  ...
  return (
    <>
      ...
      {detailsPage && <td><Button style={{ 'lineHeight': '.75', paddingLeft: 0 }} disabled={linkToOnline === '#' ? true : false} href={linkToOnline} target="_blank" color="link">Online Link</Button></td>}
