...
export const createNewRequest = async (submittedNewRequest) => {

  delete submittedNewRequest.itemToAdd

  console.log('->>> post data',submittedNewRequest)
  const request = await axios.post(`${apiPath}/`, submittedNewRequest);
